...
const translations = {
  vi: {
    ...
    // Serial Page (notice & form - hardcoded in HTML)
    'serial.notice.page.title': 'Lưu ý khi ủng hộ',
    'serial.notice.page.intro': 'Anh em ủng hộ xong vui lòng gửi bill cho dev để được active vĩnh viễn nhé.',
    'serial.notice.page.transfer': '📌 Nội dung chuyển khoản:',
    'serial.notice.page.transfer.content': 'UR + Serial + Mail hoặc tên máy',
    'serial.notice.page.amount': '💸 Mức ủng hộ:',
    'serial.notice.page.amount.min': 'Tối thiểu: 36k',
    'serial.notice.page.amount.max': 'Không giới hạn, anh em tùy tâm ❤️',
    'serial.notice.page.intl': '🌍 Thanh toán quốc tế:',
    'serial.notice.page.free.title': '🆓 Đối với anh em sử dụng active free:',
    'serial.notice.page.free.content': 'Thời hạn sử dụng sẽ là 36 ngày. Đây là thời gian để anh em trải nghiệm và thử nghiệm ROM xem có ổn định, phù hợp và xứng đáng để dùng lâu dài hay không.',
    'serial.notice.page.paid.title': '💎 Đối với anh em đã ủng hộ:',
    'serial.notice.page.paid.content': 'Sẽ được active vĩnh viễn cho đến khi thiết bị không còn được update hỗ trợ nữa.',
    'serial.notice.page.dev.title': '👨‍💻 Thông tin Dev:',
    'serial.notice.page.dev.item1': 'Dev 1:',
    'serial.notice.page.dev.item2': 'Dev 2:',
    'serial.notice.page.otherdev': '📌 Nếu DNT cho dev khác, vui lòng gửi bill và mã serial trực tiếp cho dev đó.',
    'serial.notice.page.thanks': 'Xin cảm ơn anh em đã ủng hộ!',
    'serial.form.tab.register': 'Đăng ký',
    'serial.form.tab.lookup': 'Tra cứu đăng ký',
    'serial.form.label.codename': 'Thiết bị Activation Serial',
    'serial.form.placeholder.codename': 'VD: Redmi K60 Pro - SOCRATES',
    'serial.form.label.serial': 'Serial thiết bị',
    'serial.form.placeholder.serial': 'VD: 1x2y3z4d',
    'serial.form.label.email': 'Email',
    'serial.form.placeholder.email': 'you@example.com',
    'serial.form.label.support': 'Bạn có ủng hộ dev không?',
    'serial.form.label.support.yes': 'Có, ủng hộ',
    'serial.form.label.support.no': 'Chưa / Không',
    'serial.form.support.info.desc': 'Quét mã MoMo hoặc nhấn nút bên dưới để ủng hộ dev',
    'serial.form.support.info.btn': 'Mở MoMo ủng hộ',
    'serial.form.btn.register': 'Đăng ký',
    'serial.form.lookup.label': 'Nhập email hoặc serial...',
    'serial.form.lookup.placeholder': 'Nhập email hoặc serial...',
    'serial.form.lookup.btn': 'Tìm',
    'serial.form.lookup.result.serial': 'Activation Serial:',
    'serial.form.lookup.result.device': 'Thiết bị:',
    'serial.form.lookup.result.email': 'Email:',
    'serial.form.lookup.result.date': 'Ngày đăng ký:',
    'serial.form.lookup.result.status': 'Trạng thái:',
    'serial.form.lookup.result.active': '✅ Active',
    'serial.form.lookup.result.pending': '⏳ Pending',
    'serial.form.lookup.result.rejected': '❌ Rejected',
    'serial.form.lookup.notfound': 'Không tìm thấy thông tin đăng ký.',
    'serial.form.status.processing': 'Đang xử lý...',
    'serial.form.success': 'Thành công!',
    'serial.form.success.msg': 'Serial:',
    'serial.form.success.status': 'Trạng thái:',
    'serial.form.error': 'Lỗi:',
    'serial.form.error.connection': 'Không thể kết nối server.',
    'serial.autocomplete.notfound': 'Không tìm thấy thiết bị',
  },
  ...
  en: {
    ...
    // Serial Page (notice & form - hardcoded in HTML)
    'serial.notice.page.title': 'Donation Notice',
    'serial.notice.page.intro': 'After donating, please send the bill to the dev for permanent activation.',
    'serial.notice.page.transfer': 'Transfer Content',
    'serial.notice.page.transfer.content': 'UR + Serial + Email or device name',
    'serial.notice.page.amount': 'Donation Amount',
    'serial.notice.page.amount.min': 'Minimum: 36k VND',
    'serial.notice.page.amount.max': 'Unlimited, up to you ❤️',
    'serial.notice.page.intl': 'International Payment',
    'serial.notice.page.free.title': 'For free activation users:',
    'serial.notice.page.free.content': 'Usage period is 36 days. This is the time for you to experience and test the ROM to see if it is stable, suitable and worth using long-term.',
    'serial.notice.page.paid.title': 'For supporters:',
    'serial.notice.page.paid.content': 'Will be permanently activated until the device is no longer supported.',
    'serial.notice.page.dev.title': 'Dev Information:',
    'serial.notice.page.dev.item1': 'Dev 1:',
    'serial.notice.page.dev.item2': 'Dev 2:',
    'serial.notice.page.otherdev': 'If donating to another dev, please send the bill and serial code directly to that dev.',
    'serial.notice.page.thanks': 'Thank you for your support!',
    'serial.form.tab.register': 'Register',
    'serial.form.tab.lookup': 'Lookup',
    'serial.form.label.codename': 'Device Activation Serial',
    'serial.form.placeholder.codename': 'E.g: Redmi K60 Pro - SOCRATES',
    'serial.form.label.serial': 'Device Serial',
    'serial.form.placeholder.serial': 'E.g: 1x2y3z4d',
    'serial.form.label.email': 'Email',
    'serial.form.placeholder.email': 'you@example.com',
    'serial.form.label.support': 'Will you donate to the dev?',
    'serial.form.label.support.yes': 'Yes, donate',
    'serial.form.label.support.no': 'No / Not yet',
    'serial.form.support.info.desc': 'Scan MoMo QR or click the button below to donate to the dev',
    'serial.form.support.info.btn': 'Open MoMo to Donate',
    'serial.form.btn.register': 'Register',
    'serial.form.lookup.label': 'Enter email or serial...',
    'serial.form.lookup.placeholder': 'Enter email or serial...',
    'serial.form.lookup.btn': 'Search',
    'serial.form.lookup.result.serial': 'Activation Serial:',
    'serial.form.lookup.result.device': 'Device:',
    'serial.form.lookup.result.email': 'Email:',
    'serial.form.lookup.result.date': 'Registration Date:',
    'serial.form.lookup.result.status': 'Status:',
    'serial.form.lookup.result.active': '✅ Active',
    'serial.form.lookup.result.pending': '⏳ Pending',
    'serial.form.lookup.result.rejected': '❌ Rejected',
    'serial.form.lookup.notfound': 'Registration information not found.',
    'serial.form.status.processing': 'Processing...',
    'serial.form.success': 'Success!',
    'serial.form.success.msg': 'Serial:',
    'serial.form.success.status': 'Status:',
    'serial.form.error': 'Error:',
    'serial.form.error.connection': 'Cannot connect to server.',
    'serial.autocomplete.notfound': 'Device not found',
  }
};
